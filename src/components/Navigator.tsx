    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          <Link href={import.meta.env.BASE_URL} color="inherit" underline="none" variant="h6" noWrap component="a">
            WSAN Computing
          </Link>
        </Toolbar>
      </AppBar>
    ...
    <>
      <List>
        <ListItem disablePadding>
          <ListItemButton component="a" href={import.meta.env.BASE_URL + "members/wsan"}>
            <ListItemIcon>
              <ArticleIcon />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton component="a" href={import.meta.env.BASE_URL + "members/shirashoji"}>
            <ListItemIcon>
              <ArticleIcon />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton component="a" href={import.meta.env.BASE_URL + "members/Miyazawa"}>
            <ListItemIcon>
              <ArticleIcon />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton component="a" href={import.meta.env.BASE_URL + "members/Chutoro_Detteiu"}>
            <ListItemIcon>
              <ArticleIcon />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton component="a" href={import.meta.env.BASE_URL + "members/Traveler__"}>
            <ListItemIcon>
              <ArticleIcon />
            </ListItemIcon>
...
function BasicList() {
  return (
    <>
      <List>
        <ListItem disablePadding>
          <ListItemButton component="a" href={import.meta.env.BASE_URL + "pageA"}>
            <ListItemIcon>
              <ArticleIcon />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton component="a" href={import.meta.env.BASE_URL + "pageB"}>
            <ListItemIcon>
              <ArticleIcon />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton component="a" href={import.meta.env.BASE_URL + "Images"}>
            <ListItemIcon>
              <ArticleIcon />
            </ListItemIcon>
